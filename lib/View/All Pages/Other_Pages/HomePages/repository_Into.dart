...
class Repository_Into extends StatefulWidget {
  Repository_Into(this.model,{super.key});
  RepositoriesModel model;
  @override
  State<Repository_Into> createState() => _Repository_IntoState();
}

//nb=
class _Repository_IntoState extends State<Repository_Into> {
  @override
                    ...
                    Row(
                      children:  [
                        CircleAvatar(
                          ...
                          radius: 10,
                          backgroundImage: NetworkImage(widget.model.owner!.avatarUrl??'https://icon-library.com/images/default-user-icon/default-user-icon-13.jpg'),
                        ),
                        const SizedBox(
                          width: 10,
                        ),
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemBuilder: (context, index) {
                                return  workWidgetProfile2(widget.model.fullName!,index, context);
                              }),
                        ],
                      ),
                    ),
