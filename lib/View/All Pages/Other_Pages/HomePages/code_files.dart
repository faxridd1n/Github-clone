...
class Code_Files extends StatefulWidget {
  Code_Files(this.name, {super.key});
  String name;
  // List<FoldersModel> model;
  @override
  State<Code_Files> createState() => _Code_FilesState();
}

//nb=
class _Code_FilesState extends State<Code_Files> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
            future: GetFolderService.getReposFolders(widget.name),
